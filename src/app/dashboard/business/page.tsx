                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <Card>
                      <CardHeader>
                         ...
                         <CardDescription>Aylık gelir ve sipariş büyümesi</CardDescription>
                      </CardHeader>
                      <CardContent>
                    ...
                    <Card>
                      <CardHeader>
                                                 <CardTitle>Kategoriye Göre Satışlar</CardTitle>
                         <CardDescription>Ürün kategorileri arasında gelir dağılımı</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <ResponsiveContainer width="100%" height={300}>
                          <PieChart>
